...
def convert(input_file, session_start_time,
    ...
    position.create_spatial_series(name='Position',
                                   ...
                                   reference_frame='The start of the trial, which begins at the start of the virtual '
                                                   'hallway.',
                                   conversion=0.01,
                                   description='Mouse location in the virtual hallway.',
                                   comments='The values should be >0 and <400cm. Values greater than 400cm mean that '
                                            'the mouse briefly exited the maze.',)
